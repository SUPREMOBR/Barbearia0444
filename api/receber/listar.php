...
if ($total_registro > 0) {
	...
	for ($i = 0; $i < $total_registro; $i++) {
		...
		echo '<li>';
		echo '<a href="#" class="item-link item-content" onclick="editarReceber(' . $id . ', \'' . $descricao . '\', \'' . $valorF . '\', \'' . $nome_pessoa . '\', \'' . $data_vencimentoF . '\', \'' . $data_pagamentoF . '\', \'' . $tumb_arquivo . '\', \'' . $nome_usuario_lancou . '\', \'' . $nome_usuario_pagamento . '\', \'' . $foto . '\', \'' . $ext . '\', \'' . $oc . '\', \'' . $classe_cor_whats . '\', \'' . $telefone_pessoa . '\', \'' . $whats . '\')">';
