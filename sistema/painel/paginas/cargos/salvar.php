...
$tabela = 'cargos'; // Define o nome da tabela no banco de dados
...
// Se o nome já estiver cadastrado e for um nome diferente do registro atual (editando um existente), exibe uma mensagem de erro.
