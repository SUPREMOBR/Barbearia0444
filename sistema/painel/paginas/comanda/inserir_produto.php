...
data_vencimento = curDate(), usuario_lancou = '$usuario_logado', foto = 'sem-foto.jpg', pessoa = '$cliente', pago = 'Não', produto = '$produto', 
quantidade = '$quantidade', func_comanda = '$usuario_logado', comanda = '$id', funcionario = '$funcionario', valor2 = '$valor'");
