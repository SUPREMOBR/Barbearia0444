...
<div class="">      
	<a class="btn btn-success" onclick="inserir()" class="btn btn-success btn-flat btn-pri"><i class="fa fa-plus" aria-hidden="true"></i> Novo Cliente</a>
</div>
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="date" class="form-control" id="data_nascimento" name="data_nascimento"  value="0">    
							</div> 	
						</div>
					</div>
