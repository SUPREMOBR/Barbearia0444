...
// Define o nome da página atual como fornecedores
$pag = 'fornecedores';
...
<!-- Vai listar os fornecedores  -->
<div class="bs-example widget-shadow" style="padding:15px" id="listar">

</div>

<!-- Modal para inserir ou editar um fornecedor -->
		...
		<div class="modal-content">
			...
			<form id="form">
				...
				<div class="modal-body">
					...
					<!-- Linha para chave Pix e tipo de chave -->
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
					...
					<!-- Campo oculto para armazenar o ID do fornecedor durante a edição -->
					<input type="hidden" name="id" id="id">

					<br>
					<small>
						<!-- Exibição de mensagem após ação (salvar ou erro) -->
