...
// Executa uma consulta para obter todos os registros da tabela 'categoria_produtos', ordenados pelo ID em ordem decrescente.
...
HTML;
	...
	for ($i = 0; $i < $total_registro; $i++) {
		...
		// Executa uma consulta para contar quantos produtos estão associados a essa categoria.
...
<!-- Inicialização do DataTable para tornar a tabela interativa -->
<script type="text/javascript">
	$(document).ready(function() {
		// Inicializa o DataTable para exibir os registros de forma interativa.
		$('#tabela').DataTable({
			"ordering": false,
			"stateSave": true
		});
