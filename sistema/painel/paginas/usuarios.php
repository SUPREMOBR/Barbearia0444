...
// Define o nome da página atual como usuarios
$pag = 'usuarios';
?>

<div class="">
	<!-- Botão para abrir o formulário de inserção de um Novo Usuário-->
...
<!-- Modal para inserir/editar um  Novo Usuário -->
						...
						<div class="col-md-4">
							...
							<div class="form-group">
								...
								<select class="form-control sel2" id="cargo" name="cargo" style="width:100%;">
									...
									<?php
									// Consulta os cargos cadastrados no banco de dados
									...
									// Se houver registros (cargos cadastrados)
									if ($total_registro > 0) {
										// Loop para gerar uma opção para cada cargo encontrado
										for ($i = 0; $i < $total_registro; $i++) {
											foreach ($resultado[$i] as $key => $value) {
											}
											// A variável $resultado[$i] contém os dados de cada cargo
											echo '<option value="' . $resultado[$i]['nome'] . '">' . $resultado[$i]['nome'] . '</option>';
										}
									} else {
										// Caso não haja cargos cadastrados, exibe uma opção padrão
