    ...
    <small>
        <table class="table table-hover" id="tabela">
            ...
            <tbody>
                ...
                <?php if (isset($resultado) && isset($resultado[0]) && isset($resultado[0]['instancia']) && $resultado[0]['instancia'] != ''): ?>
                    <tr>
                        <td class="esc" id="authkey_list"><?= $resultado[0]['token']; ?></td>
                        <td class="esc" id="appkey_list"><?= $resultado[0]['instancia']; ?></td>
