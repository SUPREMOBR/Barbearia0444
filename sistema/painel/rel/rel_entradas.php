...
<body>
	...
	<div class="mx-2">
		...
		<?php
		$total_entradas = 0;
		$query = $pdo->query("SELECT * FROM receber where data_pagamento >= '$dataInicial' and data_pagamento <= '$dataFinal' and tipo LIKE '$filtro'
		 and pago = 'Sim' $sql_cli  ORDER BY data_pagamento asc");
