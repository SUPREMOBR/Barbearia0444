...
<body>
	...
	<div class="mx-2">
		...
		$total_a_pagar = 0;
		$total_a_pagarF = 0;
		$query = $pdo->query("SELECT * from $tabela where ($busca >= '$dataInicial' and $busca <= '$dataFinal') and pago LIKE '$pago' 
		and valor > 0 order by id desc ");
