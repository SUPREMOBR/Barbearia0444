...
<body>
	...
	<div class="titulo_cab titulo_img"><u>Relatório de Comissões <?php echo $acao_rel ?> <?php echo $nome_funcionario ?></u></div>
	...
	<div class="mx-2">
		...
		$query = $pdo->query("SELECT * FROM pagar where data_lancamento >= '$dataInicial' and data_lancamento <= '$dataFinal' and pago 
		LIKE '$pago' and funcionario LIKE '$funcionario' and tipo = 'Comissão' ORDER BY pago asc, data_vencimento asc");
		$resultado = $query->fetchAll(PDO::FETCH_ASSOC);
				...
				<tbody>
					...
					?>
						...
						<tr align="center" class="<?php echo $classe_debito ?>">
							...
							<td class="esc"><?php echo $data_lancamentoF ?></td>
							<td class="esc"><?php echo $data_vencimentoF ?></td>
	...
	<?php if ($funcionario != "") { ?>
		...
		<div class="col-md-12 p-2" align="center">
			<div class="">
				<small><small>
						<span class=""> <b>Funcionário</b> : <?php echo @$nome_funcinario2 ?> </span>
