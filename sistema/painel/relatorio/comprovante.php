...
<br>
Serviço: <b><?php echo $id ?></b> - Data: <?php echo $dataFormatada ?>
</div>
...
for ($i=0; $i < count($dados); $i++) { 
	...
	$valor_servFormatado = number_format($valor_serv, 2, ',', '.');

	$sub_total += $valor_serv;
	$sub_totalFormatado = number_format($sub_total, 2, ',', '.');
...
<div class="row valores">			
	...
	<div class="col-6" align="right">R$ <b><?php echo @$sub_totalFormatado ?></b></div>	
</div>	
