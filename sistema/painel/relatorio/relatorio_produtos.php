...
<body>
				...
				<tbody>
					...
					?>
						...
						<tr align="center" class="<?php echo $alerta_estoque ?>">
							...
							<td class="esc">R$ <?php echo $valor_compraFormatada ?></td>
							<td class="esc">R$ <?php echo $valor_vendaFormatada ?></td>
	...
	<div class="col-md-12 p-2">
		<div class="" align="right" style="margin-right: 20px">
			...
			<span class=""> <small><small><small><small>TOTAL DE PRODUTOS</small> : <?php echo @$total_registro ?></small></small></small> </span>
